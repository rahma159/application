...
public:
    ...
    void retranslateUi(QDialog *StatisticsDialog)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(pieTab), QCoreApplication::translate("StatisticsDialog", "\360\237\245\247Pie Chart", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(barTab), QCoreApplication::translate("StatisticsDialog", "\360\237\223\212Bar Chart", nullptr));
    } // retranslateUi
